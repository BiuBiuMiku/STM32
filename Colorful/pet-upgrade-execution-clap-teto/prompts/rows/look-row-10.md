Create one horizontal look-direction strip for Codex pet `execution-clap-teto`, atlas row 10.
...
REPAIR REQUIREMENT: This row must cross decisively into the viewer's SCREEN-LEFT half. Keep Teto's feet, hips, skirt, and torso front-facing and keep her face visible; never show her back. At 202.5, 225, and 247.5, both pupils/irises and the nose tip must be LEFT of head center while also reading downward. At 270 they must be unmistakably LEFT of head center. At 292.5, 315, and 337.5 they must remain LEFT of head center while rising evenly toward the approved 000 up anchor. Do not reuse any screen-right head turn from row 9. Mirror neither the complete strip nor frame order; draw the coherent leftward family directly.
