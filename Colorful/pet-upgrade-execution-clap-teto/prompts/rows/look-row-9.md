Create one horizontal look-direction strip for Codex pet `execution-clap-teto`, atlas row 9.
...
REPAIR REQUIREMENT: Keep Teto's feet, hips, skirt, and torso front-facing in every pose. Never show her back or rotate into a rear three-quarter view. Carry all clockwise gaze meaning through iris/pupil position, eyelids, nose direction, restrained head/neck yaw or pitch, and only a very slight shoulder follow. The 112.5, 135, and 157.5 poses must still show her face and must visibly combine screen-right with downward gaze, progressing evenly toward the approved 180 down anchor.
